...
# Import logic from the reservoir_tool package
from reservoir_tool.logic.mbe import calculate_f, calculate_eo, calculate_eg, calculate_efw, estimate_ooip, calculate_error
